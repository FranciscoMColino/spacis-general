...
TRANSMITTED_RECORD_SUFFIX = 'transmitted_records'
...
class DataRecorder:
    def __init__(self,):
        ...
        self.transmitted_record_path = BASE_DIR + '/' + TRANSMITTED_RECORD_SUFFIX + '/' + TRANSMITTED_RECORD_SUFFIX + self.time_stamp + '.csv'

        self.setup_sensor_record()
        self.setup_temperature_record()
        self.setup_gps_record()
        self.setup_transmitted_record()
    ...
    def setup_transmitted_record(self):
        self.transmitted_record_file = open(self.transmitted_record_path, 'a')
        self.transmitted_record_file.write('seq_id, seq_start, time\n')
    ...
    def record_transmitted_data(self, data):
        transformed_data = [str(x) for x in data]
        self.transmitted_record_file.write(','.join(transformed_data) + '\n')
        self.transmitted_record_file.flush()
