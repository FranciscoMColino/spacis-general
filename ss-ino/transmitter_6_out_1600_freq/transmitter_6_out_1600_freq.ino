...
unsigned int time_between_tx = 15; //seconds between each transmission start
unsigned int time_safe = 2; //time before next transmission where no action is taken
